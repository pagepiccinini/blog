...
# Model #2: Effect of previous response and sex
...
# Model #3: Interaction of previous response and sex

Okay, we've now found two significant effects, but what happens if we add an interaction the model? The model below includes our two varaibles and the interaction of those variables.
